 ...
 * Run this command in your terminal to find the exact name:
 *
 * fc-list : family | grep fontname/JetBrains
 */

/* 1. Primary Font: Use the 'Mono' Nerd Font variant */
static char *font = "JetBrainsMono Nerd Font Mono:style=Medium:pixelsize=16:antialias=true:autohint=true";

/* 2. Fallback Font: Use this ONLY for Emojis */
/* You need to install 'noto-fonts-emoji' or 'ttf-joypixels' in Arch first */
...
/* Change this value to 0. This controls the gap when st starts. */
static int linespacing = 4; // 10, change this to change line spacing

// Default line spacing (in pixels)
static int voffset = 1; // Set to 1 or -1 to nudge the text up or down
/* This is only used when you press the 'Reset Spacing' keybind */
static const int defaultlinespacing = 4; 
/* Keep this as is */
static const int maxlinespacing = 20; // Optional upper limit

static int borderpx = 8; // 12, 8, 4 this inner space like padding
/*
...
static float chscale = 1.0; //1.0 this is for height
