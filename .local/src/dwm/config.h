...
static const unsigned int gappx     = 20;       /* 4, 10 gaps between windows */
...
static const char *fonts[]          = { "FiraCode:medium:size=10", "JoyPixels:pixelsize=12:antialias=true:autohint=true"};
                                    /* this is dmenu font*/
